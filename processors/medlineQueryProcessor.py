...
class MedlineQueryProcessor(BaseProcessor):

    QUERY_FILE = "data/medline/med.qry"
    DOC_FILE = "data/cran/med.all"
    lines_regexp = {}
    JUDGEMENT_FILE = "data/medline/med.rel"
    judgement_file = None
    judgements = {}
    ...
    def readOneJudgement(self,line):
        ...
        doc_id = values[2].replace('\n','')
        relevancy = values[3].replace('\n','')
